...
const createEventActionsSlice = (_set, get) => ({
    ...
    search: (query, pageNumber) => __awaiter(void 0, void 0, void 0, function* () {
        const store = get();
        ...
        const pageDocument = yield (0, utils_1.attempt)(() => (0, document_1.getDocument)(searchURL));
        if (!pageDocument) {
    ...
    handleSearchSubmit: () => __awaiter(void 0, void 0, void 0, function* () {
        const store = get();
        ...
        const entries = yield store.search(store.searchValue, store.currentPage);
        // search to cache next page
        yield store.search(store.searchValue, store.currentPage + 1);
        store.setEntries(entries);
        store.setIsLoading(false);
    }),
    nextPage: () => __awaiter(void 0, void 0, void 0, function* () {
        const store = get();
        ...
        if (entries.length === 0) {
            entries = yield store.search(store.searchValue, nextPageNumber);
        }
        // search to cache next page
        yield store.search(store.searchValue, furtherPageNumber);
    ...
    prevPage: () => __awaiter(void 0, void 0, void 0, function* () {
        const store = get();
        store.setIsLoading(true);
        store.setLoaderMessage(labels_1.default.GETTING_RESULTS);
        ...
        const prevPageEntries = yield store.search(store.searchValue, store.currentPage - 1);
    ...
    fetchEntryAlternativeDownloadURLs: (entry) => __awaiter(void 0, void 0, void 0, function* () {
        const store = get();
        ...
        const pageDocument = yield (0, utils_1.attempt)(() => (0, document_1.getDocument)(entry.mirror));
        if (!pageDocument) {
