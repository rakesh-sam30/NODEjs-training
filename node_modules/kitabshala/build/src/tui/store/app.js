...
const createAppStateSlice = (set, get) => (Object.assign(Object.assign({ CLIMode: false, setCLIMode: (CLIMode) => set({ CLIMode }) }, exports.initialAppState), { setIsLoading: (isLoading) => set({ isLoading }), setAnyEntryExpanded: (anyEntryExpanded) => set({ anyEntryExpanded }), setLoaderMessage: (loaderMessage) => set({ loaderMessage }), setSearchValue: (searchValue) => {
    ...
    }, setErrorMessage: (errorMessage) => set({ errorMessage }), setWarningMessage: (warningMessage) => {
    ...
    }, setCurrentPage: (currentPage) => set({ currentPage }), setActiveExpandedListLength: (activeExpandedListLength) => set({ activeExpandedListLength }), setListItemsCursor: (listItemsCursor) => set({ listItemsCursor }), setDetailedEntry: (detailedEntry) => set({ detailedEntry }), setEntries: (entries) => {
        const store = get();
