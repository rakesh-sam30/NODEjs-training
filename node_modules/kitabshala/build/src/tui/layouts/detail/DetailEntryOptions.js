...
const DetailEntryOptions = () => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        let isMounted = true;
        const fetchDownloadUrls = () => __awaiter(void 0, void 0, void 0, function* () {
            setAlternativeDownloadURLsLoading(true);
            const alternativeDownloadURLs = yield fetchEntryAlternativeDownloadURLs(detailedEntry);
            if (!isMounted) {
                return;
            }
    ...
    const alternativeDownloadOptions = Object.assign(Object.assign({}, alternativeDownloadURLs.reduce((prev, current, idx) => {
        return Object.assign(Object.assign({}, prev), { [idx]: {
                label: `(${idx + 1}) ${current}`,
                onSelect: () => {
                    if (detailedEntry) {
                        pushDownloadQueue(Object.assign(Object.assign({}, detailedEntry), { alternativeDirectDownloadUrl: current }));
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(ink_1.Box, { paddingLeft: 3, height: 1 }, inBulkDownloadQueue && (react_1.default.createElement(ink_1.Text, { color: "#2F7A75" },
