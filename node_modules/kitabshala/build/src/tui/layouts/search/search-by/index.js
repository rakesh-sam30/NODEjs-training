...
function SearchBy() {
    ...
    const selectedSearchByOptionLabel = selectedSearchByOption
        ? (_a = Object.entries(columnFilterQueryParamValues).find(([, value]) => value === selectedSearchByOption)) === null || _a === void 0 ? void 0 : _a[0]
        : "Default";
    return (react_1.default.createElement(ink_1.Box, { flexDirection: "column" },
        react_1.default.createElement(ink_1.Box, { height: 1 },
            ...
            react_1.default.createElement(ink_1.Text, { bold: true, color: "#2F7A75" }, selectedSearchByOptionLabel)),
