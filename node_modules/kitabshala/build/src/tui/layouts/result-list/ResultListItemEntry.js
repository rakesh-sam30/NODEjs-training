...
const ResultListItemEntry = ({ item, isActive, isExpanded, isFadedOut }) => {
    ...
    const alternativeDownloadOptions = Object.assign(Object.assign({}, alternativeDownloadURLs.reduce((prev, current, idx) => {
        return Object.assign(Object.assign({}, prev), { [idx]: {
                label: `(${idx + 1}) ${current}`,
                onSelect: () => {
                    pushDownloadQueue(Object.assign(Object.assign({}, item.data), { alternativeDirectDownloadUrl: current }));
    ...
    (0, react_1.useEffect)(() => {
        ...
        const fetchDownloadUrls = () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const alternativeDownloadURLs = yield fetchEntryAlternativeDownloadURLs(item.data);
            if (!isMounted) {
                return;
            }
    ...
    return (react_1.default.createElement(ink_1.Box, { flexDirection: "column", paddingLeft: isExpanded ? 1 : 0 },
        react_1.default.createElement(ink_1.Text, { wrap: "truncate", color: isFadedOut ? "gray" : isExpanded ? "cyanBright" : isActive ? "cyanBright" : "" },
            ...
            inBulkDownloadQueue && react_1.default.createElement(ink_1.Text, { color: "#2F7A75" },
                " ",
