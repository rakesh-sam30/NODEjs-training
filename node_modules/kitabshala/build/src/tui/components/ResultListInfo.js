...
const ResultListInfo = () => {
    ...
    return (react_1.default.createElement(ink_1.Box, null,
        react_1.default.createElement(ink_1.Text, { wrap: "truncate" },
            "Results for ",
            react_1.default.createElement(ink_1.Text, { color: "#2F7A75" }, searchValue),
            " on page",
            " ",
        ...
        react_1.default.createElement(ink_1.Text, { wrap: "truncate" },
            "Bulk download queue: ",
            react_1.default.createElement(ink_1.Text, { color: "#2F7A75" }, bulkDownloadSelectedEntries.length))));
};
